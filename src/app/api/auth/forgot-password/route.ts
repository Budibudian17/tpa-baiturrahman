...
export async function POST(request: NextRequest) {
  try {
    ...
    // Logo URL (public URL instead of file system)
    const logoUrl = `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/img/tpabaiturrahmanlogo.webp`

    // Send email using Nodemailer with Firebase reset link
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <img src="${logoUrl}" alt="TPA Baiturrahman Logo" style="width: 120px; height: 120px; margin-bottom: 10px;">
